...
public class EmployeeController 
{
 ...
 {
	 modelAndView = new ModelAndView("admin2","chakri", "Mobile Num is Valid");
	 return modelAndView;
 ...
 {
	 modelAndView=new ModelAndView("remove");
	 return modelAndView;
 }
		                  ...
		                  @RequestParam("bloodGroup")String bloodGroup)
 {
	 ...
	 modelAndView=new ModelAndView("empSys");
	 return modelAndView;
 }
 ...
 public ModelAndView remove(@RequestParam("number")String phoneNumber)
 {
	 ...
	 modelAndView=new ModelAndView("empRemove");
	 return modelAndView;
 }
